...
// === 산업기사 8종 ===
  ...
  '전자상거래관리사': {
    ...
    category: 'IT·정보',
    heroTitle: '2026년도 전자상거래관리사 합격 가이드',
    heroDesc: '전자상거래관리사는 대한상공회의소가 시행하는 국가기술자격으로, 전자상거래 기획·운영·관리 능력을 인증합니다. 쇼핑몰 창업, 이커머스 마케팅, 온라인 유통 분야 취업 시 우대되며, IT와 경영이 융합된 실용적인 자격입니다. 필기 이론과 실기(쇼핑몰 운영 실무)로 구성됩니다.',
    ...
    subjects: [
      { name: '전자상거래 기획', desc: '전자상거래 비즈니스 모델, 시장 분석, 서비스 기획' },
    ...
    books: [
      { title: '전자상거래관리사 필기 합격완성', author: '이지현', publisher: '에듀윌', year: 2024, rating: 4.5 },
      { title: '전자상거래관리사 실기 핵심이론+기출', author: '김민수', publisher: '성안당', year: 2024, rating: 4.4 },
      { title: '전자상거래관리사 기출문제 완전정복', author: '박정현', publisher: '이기적(영진닷컴)', year: 2024, rating: 4.3 },
    ],
    defaultTodos: [
      '전자상거래 비즈니스 모델 유형 정리',
...
// === 안전·소방 추가 1종 ===
  ...
  '사회조사분석사': {
    ...
    icon: 'fa-chart-line',
    category: '복지·교육',
    heroTitle: '2026년도 사회조사분석사 합격 가이드',
    heroDesc: '사회조사분석사 시험은 한국산업인력공단이 시행하는 1·2급 시험입니다. 여론 조사·시장 조사·정책 연구 등을 위한 설문 설계·자료 수집·통계 분석 전문 자격으로 리서치 기관·정부 연구소·기업 마케팅팀에서 활동합니다. 조사방법론과 통계 분석 능력이 합격의 핵심입니다.',
    passRateSummary: '2급 필기 45~60% | 실기 40~55%',
    avgPassRate: '48%',
    passRates: [
