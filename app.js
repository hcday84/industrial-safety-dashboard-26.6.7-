...
// === 추가 자격증 그룹2: 화학·환경, 안전·보건 ===
  ...
  '소방안전관리자특급': {
    ...
    heroDesc: '연면적 10만㎡ 이상 초대형 건물·공항·지하철 등 대형 특정 소방대상물의 소방 안전 관리를 책임지는 최고 등급! 한국소방안전원(kfsi.or.kr) 시행, 연 2회 1차·2차 시험.',
    ...
    schedules: [
      { round: '제24회', isCurrent: false, isDone: true,
        writtenApply: '05.01 ~ 05.08', writtenExam: '05.16', writtenResult: '05.30',
        practicalApply: '06.10 ~ 06.16', practicalExam: '06.28', finalResult: '07.11' },
      { round: '제25회', isCurrent: false, isDone: false,
        writtenApply: '08.26 ~ 09.01', writtenExam: '09.13', writtenResult: '09.26',
        practicalApply: '10.14 ~ 10.20', practicalExam: '10.31', finalResult: '11.14' },
    ],
    milestones: [
      { label: '제25회 1차 접수 시작', date: '2026-08-26' },
      { label: '제25회 1차 시험', date: '2026-09-13' },
      { label: '제25회 2차 접수 시작', date: '2026-10-14' },
      { label: '제25회 2차 시험', date: '2026-10-31' },
      { label: '제25회 최종 합격 발표', date: '2026-11-14' },
    ],
    subjects: [
  ...
  '소방안전관리자1급': {
    ...
    heroDesc: '연면적 1만5천㎡ 이상 대형 특정 소방대상물 관리! 매월 셋째 주 목요일 상시 접수, 한국소방안전원 전국 15개 시·도지부 시행.',
    ...
    tips: [
      ...
      '매월 셋째 주 목요일 접수 — 선착순 마감이므로 당일 신속 접수 권장',
      '필기 단일 시험 (실기 없음), 60점 이상 합격',
  ...
  '소방안전관리자2급': {
    ...
    heroDesc: '연면적 1만5천㎡ 미만 일반 특정 소방대상물 관리! 소방 자격증 입문 단계, 매월 셋째 주 목요일 상시 접수.',
  ...
  '소방안전관리자3급': {
    ...
    heroDesc: '소방안전관리 대상물의 기초 소방 안전 관리! 별도 응시 자격 없이 취득 가능, 매월 셋째 주 목요일 상시 접수로 편리하게 시작하세요.',
