...
const PUBLISHERS = [
  ...
  { name: '넥스트스터디',   url: 'https://www.megagong.net',         category: '공무원고시', keywords: ['넥스트스터디', '넥스트공무원', '메가공무원'] },
  { name: '두빛나래',       url: 'http://www.dubitbook.com',         category: '공무원고시', keywords: ['두빛나래', '두빛'] },
  { name: '배움',           url: 'https://www.thebaeum.co.kr',       category: '공무원고시', keywords: ['배움', '배움출판사'] },
  { name: '법문북스',       url: 'https://lawb.co.kr',               category: '공무원고시', keywords: ['법문북스', '법문'] },
  { name: '북스케치',       url: 'https://booksketch.co.kr',         category: '공무원고시', keywords: ['북스케치'] },
  { name: '서울고시각',     url: 'http://www.gosigak.co.kr',         category: '공무원고시', keywords: ['서울고시각', 'sg p&e', 'sgpe', '고시각'] },
  { name: '위포트',         url: 'https://www.weport.co.kr',         category: '공무원고시', keywords: ['위포트', 'weport'] },
  { name: '경록',           url: 'https://www.kyungrok.com',         category: '공무원고시', keywords: ['경록', '공인중개사 경록', '주택관리사 경록'] },
  { name: '메가피셋',       url: 'https://www.megapsat.co.kr',       category: '공무원고시', keywords: ['메가피셋', 'megapsat', '메가psat'] },
  { name: '무꿈사',         url: 'https://muggumsa.com',             category: '공무원고시', keywords: ['무꿈사', '국제무역사 무꿈사'] },
  { name: '북랩',           url: 'https://www.book.co.kr',           category: '공무원고시', keywords: ['북랩', 'booklab'] },
  { name: '예문에듀',       url: 'https://yeamoonedu.com',           category: '공무원고시', keywords: ['예문에듀'] },
  { name: '와우패스',       url: 'https://www.wowpass.com',          category: '공무원고시', keywords: ['와우패스', 'wowpass'] },
  { name: '해커스경찰',     url: 'https://police.hackers.com',       category: '공무원고시', keywords: ['해커스경찰', '경찰 해커스'] },
  { name: '해커스공기업',   url: 'https://public.hackers.com',       category: '공무원고시', keywords: ['해커스공기업', '공기업 해커스'] },
  { name: '해커스공무원',   url: 'https://gosi.hackers.com',         category: '공무원고시', keywords: ['해커스공무원', '공무원 해커스'] },
  { name: '해커스군무원',   url: 'https://army.hackers.com',         category: '공무원고시', keywords: ['해커스군무원', '군무원 해커스'] },
  { name: '해커스로스쿨',   url: 'https://law.hackers.com',          category: '공무원고시', keywords: ['해커스로스쿨', '로스쿨 해커스', 'leet 해커스'] },
  { name: '해커스변호사',   url: 'https://law.hackers.com',          category: '공무원고시', keywords: ['해커스변호사', '변호사 해커스'] },
  { name: '해커스소방',     url: 'https://fire.hackers.com',         category: '공무원고시', keywords: ['해커스소방', '소방 해커스'] },
  { name: '해커스감정평가사', url: 'https://law.hackers.com',        category: '공무원고시', keywords: ['해커스 감정평가사', '해커스감정평가사', '감정평가사 해커스'] },
  { name: '해커스경영아카데미', url: 'https://ecpa.hackers.com',     category: '공무원고시', keywords: ['해커스 경영아카데미', '해커스경영', '해커스cpa', '해커스세무사', '회계사 해커스'] },
  { name: '해커스PSAT',     url: 'https://psat.hackers.com',         category: '공무원고시', keywords: ['해커스psat', 'hackers psat', 'psat 해커스'] },
  { name: '해커스공인중개사', url: 'https://land.hackers.com',       category: '공무원고시', keywords: ['해커스공인중개사', '공인중개사 해커스'] },
  { name: '해커스관세사',   url: 'https://law.hackers.com',          category: '공무원고시', keywords: ['해커스관세사', '관세사 해커스'] },
  { name: '해커스노무사',   url: 'https://law.hackers.com',          category: '공무원고시', keywords: ['해커스노무사', '노무사 해커스'] },
...
// ============================================
(function() {
  const SECTION_IDS = ['schedule-section', 'monthly-section', 'books-section', 'news-section', 'analytics-section', 'study-section', 'roadmap-section', 'predictor-section', 'location-section', 'compare-section', 'tips-section', 'faq-section', 'pub-calendar-section', 'revision-section', 'notice-section'];
