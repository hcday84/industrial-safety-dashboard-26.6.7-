...
const CERT_ALIASES = {
  ...
  // ── 소방 ──────────────────────────────────────────────────────────────────
  '소방설비': '소방설비기사', '소방전기': '소방설비기사', '소방기계': '소방설비기사',
  '소방': '소방설비기사',
  '소방산': '소방설비산업기사',
...
const CERT_POPULARITY = {
  ...
  '1종운전면허(보통)':   { stars: 4.5, tag: '생활 필수', reason: '취업·생활 범용, 응시자 연 100만명 이상' },
  ...
  '소방설비기사':       { stars: 4.0, tag: '법정 필수', reason: '소방시설 점검 법정 자격, 소방업체 필수' },
  ...
  '화공산업기사':       { stars: 3.0, tag: '화학산업', reason: '화학공장·석유화학 분야 기술인력, 화공기사 발판' },
